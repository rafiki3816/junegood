$(document).ready(function(){
	...
	$(".next_arrow").click(function(){
		$(".thumbnails>li").eq(6).insertBefore(".thumbnails>li:first-child");
	});
	...
	$(".thumbnails .s5").click(function(){
		$("iframe").removeClass("on");
		$("iframe.a5").addClass("on");
	});
	$(".thumbnails .s6").click(function(){
		$("iframe").removeClass("on");
		$("iframe.a6").addClass("on");
	});
	$(".thumbnails .s7").click(function(){
		$("iframe").removeClass("on");
		$("iframe.a7").addClass("on");
	});
